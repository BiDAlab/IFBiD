...
test_dir = 'D:/DataSets/GenderWdb/test/'
train_dir = 'D:/DataSets/GenderWdb/train/'
...
model = Sequential()
model.add(Conv2D(24,kernel_size=5,activation='relu', input_shape=(120,120,3)))
...
model.load_weights(train_dir + '/Asian/0.h5')
